...
import query from '../schema/queries/countries';
...
export async function getServerSideProps() {
  ...
  return {
    props: { genres, countries: data.countries.slice(0, 4) },
  };
}
